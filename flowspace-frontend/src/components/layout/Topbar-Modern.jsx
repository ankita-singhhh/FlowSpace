...
import { Bell, User, Settings, LogOut, Check, X, AlertCircle, CheckCircle2, Info, Search } from 'lucide-react';
    ...
    <div className="flex items-center justify-between">
      ...
      <div className="flex items-center gap-4 ml-4">
        ...
        <div className="relative">
          ...
          {showNotifications && (
            <div className="absolute top-full right-0 mt-2 bg-white border border-gray-200 rounded-lg shadow-lg min-w-[350px] z-50" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="relative">
          ...
          {showUserDropdown && (
            <div className="absolute top-full right-0 mt-2 bg-white border border-gray-200 rounded-lg shadow-lg min-w-[200px] z-50" onClick={(e) => e.stopPropagation()}>
              <div className="py-2">
