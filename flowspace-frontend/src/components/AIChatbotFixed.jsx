  ...
  useEffect(() => {
    const checkAPIStatus = async () => {
      try {
        ...
        if (response.ok) {
          // API is working, show welcome message
          setMessages([{
            id: 1,
            type: 'system',
...
Try asking me anything about your productivity! 🚀`,
          ...
          // API not working, show setup message
          setMessages([{
            id: 1,
            type: 'system',
...
## 🚀 **What the AI Can Do:**
- Create tasks from natural language ("Create task: Finish report by Friday")
- Plan your weekly schedule ("Plan my week")
- Give productivity advice ("What should I focus on today?")
- Help prioritize your work

**Start with Google Gemini - it's completely free!** 🎯`,
            timestamp: new Date().toISOString()
          }]);
        }
      } catch (error) {
        console.error('API check failed:', error);
        // Show setup message on error
        setMessages([{
          id: 1,
          type: 'system',
          content: `🤖 **AI Chatbot Setup Required**
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  border: 'none',
                  borderRadius: '8px',
                  backgroundColor: inputValue.trim() ? '#06b6d4' : (isDark ? '#374151' : '#d1d5db'),
