            ...
            <div className={`${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} p-4 md:p-6 rounded-xl border shadow-sm lg:col-span-2`}>
              ...
              <div className="space-y-3">
                {todayTasks.slice(0, isMobile ? 2 : 3).map(task => (
                  <div key={task.id} className={`flex items-center gap-3 p-3 ${isDark ? 'bg-gray-700' : 'bg-gray-50'} rounded-lg`}>
            ...
            <div className={`${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} p-4 md:p-6 rounded-xl border shadow-sm`}>
              ...
              <div className="space-y-3">
                {upcomingReminders.map(reminder => (
                  <div key={reminder.id} className={`flex items-center gap-3 p-3 ${isDark ? 'bg-gray-700' : 'bg-gray-50'} rounded-lg`}>
            ...
            <div className={`${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} p-4 md:p-6 rounded-xl border shadow-sm`}>
              ...
              <div className="space-y-3">
                {todayHabits.map(habit => (
                  <div key={habit.id} className={`flex items-center gap-3 p-3 ${isDark ? 'bg-gray-700' : 'bg-gray-50'} rounded-lg`}>
      ...
      {isFocusMode && (
        <div className={`${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} p-6 md:p-8 rounded-xl border shadow-sm`}>
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="space-y-4">
              {todayTasks.map(task => (
                <div key={task.id} className={`flex items-start gap-4 p-6 ${isDark ? 'bg-gray-700' : 'bg-white'} border rounded-xl shadow-sm ${task.priority === 'High' ? 'border-l-4 border-l-red-500' : task.priority === 'Medium' ? 'border-l-4 border-l-amber-500' : 'border-l-4 border-l-green-500'}`}>
                  <div className="mt-1">
